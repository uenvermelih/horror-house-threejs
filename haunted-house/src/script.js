...
const tick = () =>
{
    ...
    ghost1.position.x = Math.cos(ghost1Angle) * (7 * Math.sin(elapsedTime * 0.12))
    ghost1.position.z = Math.sin(ghost1Angle) * 4
    ghost1.position.y = 1 + Math.sin(elapsedTime) * 0.4

    const ghost2Angle = elapsedTime * 0.16
    ghost2.position.x = Math.cos(ghost2Angle) * 5
    ghost2.position.z = Math.sin(ghost2Angle) * 5
    ghost2.position.y = Math.sin(elapsedTime) * 2 + Math.sin(elapsedTime) * 1
